...
const I18n = (() => {
  ...
  const T = {
    ...
    landing_subtitle: { fr:'Plateforme médicale universelle sécurisée', en:'Secure universal medical platform', es:'Plataforma médica universal segura', ar:'منصة طبية عالمية آمنة', pt:'Plataforma médica universal segura', sw:'Jukwaa la matibabu la ulimwengu', zh:'安全的通用医疗平台', de:'Sichere universelle medizinische Plattform', ru:'Защищённая универсальная медицинская платформа', hi:'सुरक्षित सार्वभौमिक चिकित्सा प्लेटफ़ॉर्म' },
