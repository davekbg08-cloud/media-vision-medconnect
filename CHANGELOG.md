...
**Coût Blaze** réduit par les leviers déjà acquis (listeners bornés par établissement au lieu de collection-entière, arrêt des doubles écritures, persistance hors-ligne, `minInstances=0` sur les fonctions).
