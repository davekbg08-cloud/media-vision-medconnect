...
test('Android build.gradle porte versionCode 49 et versionName 2.9.48', () => {
...
test('sw.js porte le cache medconnect-v4.49', () => {
  assert.match(read('sw.js'), new RegExp(`const CACHE = '${EXPECTED.cache}'`));
});

test('MainActivity pointe la PWA en ?apk=v2.9.48', () => {
