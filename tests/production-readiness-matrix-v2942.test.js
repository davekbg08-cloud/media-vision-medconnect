...
test('Android build.gradle porte versionCode 43 et versionName 2.9.42', () => {
...
test('sw.js porte le cache medconnect-v4.43', () => {
  assert.match(read('sw.js'), new RegExp(`const CACHE = '${EXPECTED.cache}'`));
});

test('MainActivity pointe la PWA en ?apk=v2.9.42', () => {
