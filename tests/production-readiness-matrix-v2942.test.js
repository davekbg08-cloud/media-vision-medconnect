...
test('Android build.gradle porte versionCode 47 et versionName 2.9.46', () => {
...
test('sw.js porte le cache medconnect-v4.47', () => {
  assert.match(read('sw.js'), new RegExp(`const CACHE = '${EXPECTED.cache}'`));
});

test('MainActivity pointe la PWA en ?apk=v2.9.46', () => {
