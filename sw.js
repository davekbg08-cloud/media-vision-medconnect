...
const ASSETS = [
  ...
  './js/transfer_service.js', './js/network.js', './js/transfer_ui_patch.js',
  ...
  './js/auth.js', './js/app.js', './js/global_back_button.js', './js/auth-ui-cleanup.js',
  './assets/icon.png',
